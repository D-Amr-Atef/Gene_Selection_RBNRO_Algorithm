...
class Utils(Root):
        ...
        metrics = ["Fitness", "Accuracy", "Feature_size", "Time"]
        terms = ["best", "mean", "worst", "std"]
        
        def __init__(self, dataset_list=None, algo_dicts=None, obj_fun_dicts=None, trans_fun_dicts=None, f_combina=None):
        ...
        def _db_handler__(self):
                ...
                for ds in self.dataset_list:
                        ds_splitter = DatasetSplitter(ds_name= ds, f_combina= self.f_combina)
        ...
        def _ax_creator__(self, nrows, idx, epoch, alph, ds):
                ...
                ax.set(xlabel="No. of iterations", ylabel="Mean fitness")
